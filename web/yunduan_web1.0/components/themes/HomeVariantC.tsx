...
function TerminalHeader({
  ...
  const defaultLinks = [
    { label: '~/videos', url: '#videos', openInNewTab: false },
    { label: '~/articles', url: '#articles', openInNewTab: false },
  ...
  return (
    <div className="terminal-home-header" style={{
      ...
      <div className="terminal-home-prompt" style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
        ...
        <Link href="/" style={{ color: MUTED, textDecoration: 'none' }}>captain@corner:~$</Link>
...
{`  ┌────────────────────────────────────┐
  │  CAPTAIN CORNER  ·  船长的角落      │
  │  ~/posts  —  navigating AI content  │
  └────────────────────────────────────┘`}
          </div>
          <div className="terminal-banner-meta" style={{ marginTop: 14, fontSize: 14, display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span style={{ color: FG }}>船长的角落</span>
