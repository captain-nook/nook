    ...
    <div className="min-h-screen bg-[var(--editor-app-bg)] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-[#2f80ed] text-white text-xl font-bold mb-4">
            船
          </div>
          <h1 className="text-2xl font-bold text-[var(--editor-ink)]">船长的角落</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full border border-[var(--editor-line)] rounded-lg px-3.5 py-2.5 text-sm text-[var(--editor-ink)] bg-[var(--editor-app-bg)] outline-none transition focus:border-[#2f80ed] focus:ring-2 focus:ring-[#2f80ed]/10 placeholder:text-[var(--editor-muted)]"
              />
            </div>
            ...
            <button
              ...
              className="w-full bg-[#2f80ed] text-white rounded-lg py-2.5 text-sm font-semibold hover:brightness-105 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? '登录中…' : '登录'}
            </button>
          </form>
