...
import { getLocalWechatPosts } from '@/lib/local-wechat-posts'
...
export default async function Home({
  ...
  const localWechatPosts = await getLocalWechatPosts(6)
  ...
  return (
    <>
      ...
      <HomeClient
        ...
        localWechatPosts={localWechatPosts}
